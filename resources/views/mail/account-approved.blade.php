...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    <title>Account Approved — OEC Americas</title>
    <meta charset="utf-8"> 
  ...
  <body width="100%" style="margin:0; mso-line-height-rule:exactly; background-color:#f4f5f7;">
    <center role="article" aria-roledescription="email" lang="en" style="width:100%; background-color:#f4f5f7;">
      ...
      <div style="display:none; font-size:1px; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden; mso-hide:all;">
        Hello, {{$userName}}! Account Approved.
      </div>
                  ...
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#ffffff; border-radius:12px; box-shadow:0 2px 6px rgba(0,0,0,0.06);">
                    <tr>
                      <td class="px-sm-24" style="padding:32px 40px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', sans-serif; color:#0f172a;">
                        <h1 class="text" style="margin:0 0 12px; font-size:24px; font-weight:700; line-height:1.25;">Your Account is Approved!</h1>
                        <p class="text" style="margin:0 0 16px; font-size:16px; line-height:1.6;">Hello {{$userName}},</p>
                        <p class="text" style="margin:0 0 16px; font-size:16px; line-height:1.6;">We’re excited to let you know that your account has been successfully approved! You can now log in and start using all the features of OEC Americas.</p>

                        <!-- Button -->
                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:24px 0 8px;">
                          <tr>
                            <td>
                              <a class="btn" href="https://oec-americas.com/login" target="_blank" style="display:inline-block; background:#ff0100; color:#ffffff; padding:12px 20px; border-radius:8px; font-weight:600; font-size:16px;">Login to Your Account</a>
                            </td>
                          </tr>
                        </table>

                        <!-- Fallback link -->
                        <p class="muted" style="margin:12px 0 0; font-size:12px; color:#64748b;">If the button doesn’t work, copy and paste this link into your browser:<br>
                          <span style="word-break:break-all;"><a href="https://oec-americas.com/login" target="_blank" style="color:#2563eb;">https://oec-americas.com/login</a></span>
                        </p>

                        <!-- Help text -->
                        <p class="muted" style="margin:20px 0 0; font-size:12px; color:#64748b;">Didn’t create this account? You can safely ignore this email or <a href="https://oec-americas.com/reach-us" target="_blank" style="color:#2563eb;">contact support</a>.</p>
                      </td>
                    </tr>
                  </table>
                </td>
